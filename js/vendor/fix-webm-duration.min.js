...
!(function (e, t) {
  ...
  function y(e, t, n, a) {
    if (("object" == typeof n && ((a = n), (n = void 0)), !n))
    ...
    try {
      ...
      ((i.onloadend = function () {
        try {
          var r = new p(new Uint8Array(i.result));
          r.fixDuration(t, a) && (e = r.toBlob(e.type));
        } catch (e) {}
        n(e);
      }),
  ...
  return (
    ...
    t(r, n),
    (r.prototype.getFloatArrayType = function () {
    ...
    (o.prototype.updateBySource = function () {
      for (
        ...
        var t = this.readUint(),
          i = this.readUint(),
          p = Math.min(this.offset + i, this.source.length),
          y = this.source.slice(this.offset, p),
          m = e[t] || { name: "Unknown", type: "Unknown" },
          s = n;
        switch (m.type) {
          case "Container":
            s = o;
        ...
        var c = new s(m.name, m.type);
        (c.setSource(y),
          this.data.push({ id: t, idHex: t.toString(16), data: c }));
      }
    }),
    (o.prototype.writeUint = function (e, t) {
      for (var n = 1, a = 128; e >= a && n < 8; n++, a *= 128);
      if (!t)
        for (var i = a + e, r = n - 1; r >= 0; r--) {
          var o = i % 256;
          ((this.source[this.offset + r] = o), (i = (i - o) / 256));
        }
      this.offset += n;
    }),
    (o.prototype.writeSections = function (e) {
      ...
      for (var t = 0; t < this.data.length; t++) {
        ...
        (this.writeUint(n.id, e),
          this.writeUint(i, e),
          e || this.source.set(a, this.offset),
          (this.offset += i));
      }
      return this.offset;
    }),
    ...
    t(p, o),
    (p.prototype.fixDuration = function (e, t) {
      var n = t && t.logger;
      void 0 === n
        ? (n = function (e) {
            console.log(e);
        ...
        : n || (n = function () {});
      var a = this.getSectionById(139690087);
      if (!a) return (n("[fix-webm-duration] Segment section is missing"), !1);
      var i = a.getSectionById(88713574);
      if (!i) return (n("[fix-webm-duration] Info section is missing"), !1);
      var o = i.getSectionById(710577);
      if (!o)
        return (n("[fix-webm-duration] TimecodeScale section is missing"), !1);
      var p = i.getSectionById(1161);
      if (p) {
        if (!(p.getValue() <= 0))
          return (
            n(
              `[fix-webm-duration] Duration section is present, and the value is ${p.getValue()}`,
            ),
            !1
          );
        (n(
          `[fix-webm-duration] Duration section is present, but the value is ${p.getValue()}`,
        ),
          p.setValue(e));
      } else
        (n("[fix-webm-duration] Duration section is missing"),
          (p = new r("Duration", "Float")).setValue(e),
          i.data.push({ id: 1161, data: p }));
      return (
        o.setValue(1e6),
        i.updateByData(),
        a.updateByData(),
